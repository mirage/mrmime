...
let database =
  Map.add "video"
    (Set.of_list
       [
         "1d-interleaved-parityfec"; "3gpp"; "3gpp-tt"; "3gpp2"; "BMPEG";
         "BT656"; "CelB"; "DV"; "H261"; "H263"; "H263-1998"; "H263-2000";
         "H264"; "H264-RCDO"; "H264-SVC"; "H265"; "JPEG"; "MP1S"; "MP2P";
         "MP2T"; "MP4V-ES"; "MPV"; "SMPTE292M"; "VP8"; "encaprtp"; "example";
         "iso.segment"; "jpeg2000"; "mj2"; "mp4"; "mpeg"; "mpeg4-generic"; "nv";
         "ogg"; "parityfec"; "pointer"; "quicktime"; "raptorfec"; "raw";
         "rtp-enc-aescm128"; "rtploopback"; "rtx"; "ulpfec"; "vc1"; "vnd.CCTV";
         "vnd.dece.hd"; "vnd.dece.mobile"; "vnd.dece.mp4"; "vnd.dece.pd";
         "vnd.dece.sd"; "vnd.dece.video"; "vnd.directv.mpeg";
         "vnd.directv.mpeg-tts"; "vnd.dlna.mpeg-tts"; "vnd.dvb.file"; "vnd.fvt";
         "vnd.hns.video"; "vnd.iptvforum.1dparityfec-1010";
         "vnd.iptvforum.1dparityfec-2005"; "vnd.iptvforum.2dparityfec-1010";
         "vnd.iptvforum.2dparityfec-2005"; "vnd.iptvforum.ttsavc";
         "vnd.iptvforum.ttsmpeg2"; "vnd.motorola.video"; "vnd.motorola.videop";
         "vnd.mpegurl"; "vnd.ms-playready.media.pyv";
         "vnd.nokia.interleaved-multimedia"; "vnd.nokia.videovoip";
         "vnd.objectvideo"; "vnd.radgamettools.bink";
         "vnd.radgamettools.smacker"; "vnd.sealed.mpeg1"; "vnd.sealed.mpeg4";
         "vnd.sealed.swf"; "vnd.sealedmedia.softseal.mov"; "vnd.uvvu.mp4";
         "vnd.vivo";
       ])
    (Map.add "text"
       (Set.of_list
          [
            ...
            "css"; "csv"; "csv-schema"; "directory"; "dns"; "ecmascript";
            "encaprtp"; "enriched"; "example"; "fwdred"; "grammar-ref-list";
            "html"; "javascript"; "jcr-cnd"; "markdown"; "mizar"; "n3";
            "parameters"; "parityfec"; "plain"; "provenance-notation";
            "prs.fallenstein.rst"; "prs.lines.tag"; "prs.prop.logic";
            "raptorfec"; "rfc822-headers"; "richtext"; "rtf";
            "rtp-enc-aescm128"; "rtploopback"; "rtx"; "sgml"; "t140";
            "tab-separated-values"; "troff"; "turtle"; "ulpfec"; "uri-list";
            "vcard"; "vnd.DMClientScript"; "vnd.IPTC.NITF"; "vnd.IPTC.NewsML";
            "vnd.a"; "vnd.abc"; "vnd.curl"; "vnd.debian.copyright";
            "vnd.dvb.subtitle"; "vnd.esmertec.theme-descriptor"; "vnd.fly";
            "vnd.fmi.flexstor"; "vnd.graphviz"; "vnd.in3d.3dml";
            "vnd.in3d.spot"; "vnd.latex-z"; "vnd.motorola.reflex";
       ...
       (Map.add "multipart"
          (Set.of_list
             [
               ...
               "parallel"; "related"; "report"; "signed"; "voice-message";
               "x-mixed-replace";
             ])
          (Map.add "model"
             (Set.of_list
                [
                  "example"; "iges"; "mesh"; "vnd.collada+xml"; "vnd.dwf";
                  "vnd.flatland.3dml"; "vnd.gdl"; "vnd.gs-gdl"; "vnd.gtw";
                  "vnd.moml+xml"; "vnd.mts"; "vnd.opengex";
                  "vnd.parasolid.transmit.binary";
                  "vnd.parasolid.transmit.text";
                  "vnd.rosette.annotated-data-model";
                  "vnd.valve.source.compiled-map"; "vnd.vtu"; "vrml";
                  "x3d+fastinfoset"; "x3d+xml"; "x3d-vrml";
                ])
             (Map.add "message"
                (Set.of_list
                   [
                     ...
                     "http"; "imdn+xml"; "news"; "partial"; "rfc822"; "s-http";
                     "sip"; "sipfrag"; "tracking-status"; "vnd.si.simp";
                     "vnd.wfa.wsc";
                   ])
                (Map.add "image"
                   (Set.of_list
                      [
                        "bmp"; "cgm"; "emf"; "example"; "fits"; "g3fax"; "gif";
                        "ief"; "jp2"; "jpeg"; "jpm"; "jpx"; "ktx"; "naplps";
                        "png"; "prs.btif"; "prs.pti"; "pwg-raster"; "svg+xml";
                        "t38"; "tiff"; "tiff-fx"; "vnd.adobe.photoshop";
                        "vnd.airzip.accelerator.azv"; "vnd.cns.inf2";
                        "vnd.dece.graphic"; "vnd.djvu"; "vnd.dvb.subtitle";
                        "vnd.dwg"; "vnd.dxf"; "vnd.fastbidsheet"; "vnd.fpx";
                        "vnd.fst"; "vnd.fujixerox.edmics-mmr";
                        "vnd.fujixerox.edmics-rlc"; "vnd.globalgraphics.pgb";
                        "vnd.microsoft.icon"; "vnd.mix"; "vnd.mozilla.apng";
                      ...
                      (Map.add "audio"
                         (Set.of_list
                            [
                              ...
                              "3gpp2"; "AMR"; "AMR-WB";
                              "ATRAC-ADVANCED-LOSSLESS"; "ATRAC-X"; "ATRAC3";
                              "BV16"; "BV32"; "CN"; "DAT12"; "DV"; "DVI4";
                              "EVRC"; "EVRC-QCP"; "EVRC0"; "EVRC1"; "EVRCB";
                              "EVRCB0"; "EVRCB1"; "EVRCNW"; "EVRCNW0";
                              "EVRCNW1"; "EVRCWB"; "EVRCWB0"; "EVRCWB1"; "EVS";
                              "G711-0"; "G719"; "G722"; "G7221"; "G723";
                              "G726-16"; "G726-24"; "G726-32"; "G726-40";
                              "G728"; "G729"; "G7291"; "G729D"; "G729E"; "GSM";
                              "GSM-EFR"; "GSM-HR-08"; "L16"; "L20"; "L24"; "L8";
                              "LPC"; "MP4A-LATM"; "MPA"; "PCMA"; "PCMA-WB";
                              "PCMU"; "PCMU-WB"; "QCELP"; "RED"; "SMV";
                              "SMV-QCP"; "SMV0"; "UEMCLIP"; "VDVI"; "VMR-WB";
                              "ac3"; "amr-wb+"; "aptx"; "asc"; "basic";
                              "clearmode"; "dls"; "dsr-es201108";
                              "dsr-es202050"; "dsr-es202211"; "dsr-es202212";
                              "eac3"; "encaprtp"; "example"; "fwdred"; "iLBC";
                              "ip-mr_v2.5"; "mobile-xmf"; "mp4"; "mpa-robust";
                              "mpeg"; "mpeg4-generic"; "ogg"; "opus";
                              "parityfec"; "prs.sid"; "raptorfec";
                              "rtp-enc-aescm128"; "rtp-midi"; "rtploopback";
                              "rtx"; "sp-midi"; "speex"; "t140c"; "t38";
                              "telephone-event"; "tone"; "ulpfec";
                              "vnd.3gpp.iufp"; "vnd.4SB"; "vnd.CELP";
                              "vnd.audiokoz"; "vnd.cisco.nse";
                              "vnd.cmles.radio-events"; "vnd.cns.anp1";
                              "vnd.cns.inf1"; "vnd.dece.audio";
                              "vnd.digital-winds"; "vnd.dlna.adts";
                              "vnd.dolby.heaac.1"; "vnd.dolby.heaac.2";
                              "vnd.dolby.mlp"; "vnd.dolby.mps"; "vnd.dolby.pl2";
                              "vnd.dolby.pl2x"; "vnd.dolby.pl2z";
                              "vnd.dolby.pulse.1"; "vnd.dra"; "vnd.dts";
                              "vnd.dts.hd"; "vnd.dvb.file"; "vnd.everad.plj";
                         ...
                         (Map.add "application"
                            (Set.of_list
                               [
                                 ...
                                 "3gpdash-qoe-report+xml"; "3gpp-ims+xml";
                                 "A2L"; "AML"; "ATF"; "ATFX"; "ATXML";
                                 "CALS-1840"; "CDFX+XML"; "CEA"; "CSTAdata+xml";
                                 "DCD"; "DII"; "DIT"; "EDI-X12"; "EDI-consent";
                                 "EDIFACT"; "EmergencyCallData.Comment+xml";
                                 "EmergencyCallData.DeviceInfo+xml";
                                 "EmergencyCallData.ProviderInfo+xml";
                                 "EmergencyCallData.ServiceInfo+xml";
                                 "EmergencyCallData.SubscriberInfo+xml"; "H224";
                                 "LXF"; "MF4"; "ODX"; "PDX"; "activemessage";
                                 ...
                                 "alto-error+json"; "alto-networkmap+json";
                                 "alto-networkmapfilter+json"; "andrew-inset";
                                 "applefile"; "atom+xml"; "atomcat+xml";
                                 "atomdeleted+xml"; "atomicmail"; "atomsvc+xml";
                                 "auth-policy+xml"; "bacnet-xdd+zip";
                                 "batch-SMTP"; "beep+xml"; "calendar+json";
                                 "calendar+xml"; "call-completion"; "cbor";
                                 "ccmp+xml"; "ccxml+xml"; "cdmi-capability";
                                 "cdmi-container"; "cdmi-domain"; "cdmi-object";
                                 "cdmi-queue"; "cdni"; "cea-2018+xml";
                                 "cellml+xml"; "cfw"; "cms"; "cnrp+xml";
                                 "coap-group+json"; "commonground";
                                 "conference-info+xml"; "cpl+xml"; "csrattrs";
                                 "csta+xml"; "csvm+json"; "cybercash";
                                 "dash+xml"; "dashdelta"; "davmount+xml";
                                 "dca-rft"; "dec-dx"; "dialog-info+xml";
                                 "dicom"; "dns"; "dskpp+xml"; "dssc+der";
                                 "dssc+xml"; "dvcs"; "ecmascript"; "efi";
                                 "emma+xml"; "emotionml+xml"; "encaprtp";
                                 "epp+xml"; "epub+zip"; "eshop"; "example";
                                 "exi"; "fastinfoset"; "fastsoap"; "fdt+xml";
                                 "fits"; "font-sfnt"; "font-tdpfr"; "font-woff";
                                 "framework-attributes+xml"; "gzip"; "held+xml";
                                 "http"; "hyperstudio"; "ibe-key-request+xml";
                                 "ibe-pkg-reply+xml"; "ibe-pp-data"; "iges";
                                 "im-iscomposing+xml"; "index"; "index.cmd";
                                 "index.obj"; "index.response"; "index.vnd";
                                 "inkml+xml"; "iotp"; "ipfix"; "ipp"; "isup";
                                 "its+xml"; "javascript"; "jose"; "jose+json";
                                 "jrd+json"; "json"; "json-patch+json";
                                 "json-seq"; "jwk+json"; "jwk-set+json"; "jwt";
                                 "kpml-request+xml"; "kpml-response+xml";
                                 "ld+json"; "lgr+xml"; "link-format";
                                 "load-control+xml"; "lost+xml"; "lostsync+xml";
                                 "mac-binhex40"; "macwriteii"; "mads+xml";
                                 "marc"; "marcxml+xml"; "mathematica";
                                 "mathml+xml"; "mathml-content+xml";
                                 "mathml-presentation+xml";
                                 "mbms-associated-procedure-description+xml";
                                 "mbms-deregister+xml"; "mbms-envelope+xml";
                                 "mbms-msk+xml"; "mbms-msk-response+xml";
                                 ...
                                 "media_control+xml"; "mediaservercontrol+xml";
                                 "merge-patch+json"; "metalink4+xml";
                                 "mets+xml"; "mikey"; "mods+xml"; "moss-keys";
                                 "moss-signature"; "mosskey-data";
                                 "mosskey-request"; "mp21"; "mp4";
                                 "mpeg4-generic"; "mpeg4-iod"; "mpeg4-iod-xmt";
                                 "mrb-consumer+xml"; "mrb-publish+xml";
                                 "msc-ivr+xml"; "msc-mixer+xml"; "msword";
                                 "mxf"; "nasdata"; "news-checkgroups";
                                 "news-groupinfo"; "news-transmission";
                                 "nlsml+xml"; "nss"; "ocsp-request";
                                 "ocsp-response"; "octet-stream"; "oda";
                                 "oebps-package+xml"; "ogg"; "oxps";
                                 "p2p-overlay+xml"; "parityfec";
                                 "patch-ops-error+xml"; "pdf"; "pgp-encrypted";
                                 "pgp-keys"; "pgp-signature"; "pidf+xml";
                                 "pidf-diff+xml"; "pkcs10"; "pkcs12";
                                 "pkcs7-mime"; "pkcs7-signature"; "pkcs8";
                                 "pkix-attr-cert"; "pkix-cert"; "pkix-crl";
                                 ...
                                 "qsig"; "raptorfec"; "rdap+json"; "rdf+xml";
                                 "reginfo+xml"; "relax-ng-compact-syntax";
                                 "remote-printing"; "reputon+json";
                                 "resource-lists+xml";
                                 "resource-lists-diff+xml"; "rfc+xml"; "riscos";
                                 "rlmi+xml"; "rls-services+xml";
                                 "rpki-ghostbusters"; "rpki-manifest";
                                 "rpki-roa"; "rpki-updown"; "rtf";
                                 "rtploopback"; "rtx"; "samlassertion+xml";
                                 "samlmetadata+xml"; "sbml+xml"; "scaip+xml";
                                 "scim+json"; "scvp-cv-request";
                                 "scvp-cv-response"; "scvp-vp-request";
                                 "scvp-vp-response"; "sdp"; "sep+xml";
                                 "sep-exi"; "session-info"; "set-payment";
                                 ...
                                 "vnd.3gpp.ussd+xml"; "vnd.3gpp2.bcmcsinfo+xml";
                                 "vnd.3gpp2.sms"; "vnd.3gpp2.tcap";
                                 "vnd.3lightssoftware.imagescal";
                                 "vnd.FloGraphIt";
                                 "vnd.HandHeld-Entertainment+xml"; "vnd.Kinar";
                                 "vnd.MFER"; "vnd.Mobius.DAF"; "vnd.Mobius.DIS";
                                 "vnd.Mobius.MBK"; "vnd.Mobius.MQY";
                                 "vnd.Mobius.MSL"; "vnd.Mobius.PLC";
                                 "vnd.Mobius.TXF"; "vnd.Quark.QuarkXPress";
                                 ...
                                 "vnd.adobe.xdp+xml"; "vnd.adobe.xfdf";
                                 "vnd.aether.imp"; "vnd.ah-barcode";
                                 "vnd.ahead.space"; "vnd.airzip.filesecure.azf";
                                 "vnd.airzip.filesecure.azs";
                                 "vnd.americandynamics.acc"; "vnd.amiga.ami";
                                 "vnd.amundsen.maze+xml"; "vnd.anki";
                                 ...
                                 "vnd.arastra.swi"; "vnd.aristanetworks.swi";
                                 "vnd.artsquare"; "vnd.astraea-software.iota";
                                 "vnd.audiograph"; "vnd.autopackage";
                                 "vnd.avistar+xml"; "vnd.balsamiq.bmml+xml";
                                 "vnd.balsamiq.bmpr"; "vnd.bekitzur-stech+json";
                                 "vnd.biopax.rdf+xml"; "vnd.blueice.multipass";
                                 "vnd.bluetooth.ep.oob"; "vnd.bluetooth.le.oob";
                                 "vnd.bmi"; "vnd.businessobjects";
                                 "vnd.cab-jscript"; "vnd.canon-cpdl";
                                 "vnd.canon-lips";
                                 ...
                                 "vnd.coffeescript"; "vnd.collection+json";
                                 "vnd.collection.doc+json";
                                 "vnd.collection.next+json";
                                 "vnd.commerce-battelle"; "vnd.commonspace";
                                 "vnd.contact.cmsg"; "vnd.coreos.ignition+json";
                                 "vnd.cosmocaller"; "vnd.crick.clicker";
                                 "vnd.crick.clicker.keyboard";
                                 "vnd.crick.clicker.palette";
                                 "vnd.crick.clicker.template";
                                 "vnd.crick.clicker.wordbank";
                                 "vnd.criticaltools.wbs+xml"; "vnd.ctc-posml";
                                 "vnd.ctct.ws+xml"; "vnd.cups-pdf";
                                 "vnd.cups-postscript"; "vnd.cups-ppd";
                                 "vnd.cups-raster"; "vnd.cups-raw"; "vnd.curl";
                                 "vnd.cyan.dean.root+xml"; "vnd.cybank";
                                 ...
                                 "vnd.ericsson.quickcall"; "vnd.eszigno3+xml";
                                 "vnd.etsi.aoc+xml"; "vnd.etsi.asic-e+zip";
                                 "vnd.etsi.asic-s+zip"; "vnd.etsi.cug+xml";
                                 ...
                                 "vnd.etsi.mcid+xml"; "vnd.etsi.mheg5";
                                 "vnd.etsi.overload-control-policy-dataset+xml";
                                 "vnd.etsi.pstn+xml"; "vnd.etsi.sci+xml";
                                 "vnd.etsi.simservs+xml";
                                 "vnd.etsi.timestamp-token"; "vnd.etsi.tsl+xml";
                                 "vnd.etsi.tsl.der"; "vnd.eudora.data";
                                 "vnd.ezpix-album"; "vnd.ezpix-package";
                                 "vnd.f-secure.mobile";
                                 "vnd.fastcopy-disk-image"; "vnd.fdf";
                                 "vnd.fdsn.mseed"; "vnd.fdsn.seed"; "vnd.ffsns";
                                 "vnd.filmit.zfc"; "vnd.fints";
                                 ...
                                 "vnd.fujitsu.oasysprs"; "vnd.fujixerox.ART-EX";
                                 "vnd.fujixerox.ART4"; "vnd.fujixerox.HBPL";
                                 ...
                                 "vnd.ims.imsccv1p1"; "vnd.ims.imsccv1p2";
                                 "vnd.ims.imsccv1p3";
                                 ...
                                 "vnd.insors.igm"; "vnd.intercon.formnet";
                                 "vnd.intergeo"; "vnd.intertrust.digibox";
                                 "vnd.intertrust.nncp"; "vnd.intu.qbo";
                                 "vnd.intu.qfx"; "vnd.iptc.g2.catalogitem+xml";
                                 ...
                                 "vnd.kodak-descriptor"; "vnd.las.las+xml";
                                 ...
                                 "vnd.meridian-slingshot"; "vnd.mfmp";
                                 ...
                                 "vnd.motorola.iprm"; "vnd.mozilla.xul+xml";
                                 "vnd.ms-3mfdocument";
                                 "vnd.ms-PrintDeviceCapabilities+xml";
                                 "vnd.ms-PrintSchemaTicket+xml";
                                 "vnd.ms-artgalry"; "vnd.ms-asf";
                                 "vnd.ms-cab-compressed"; "vnd.ms-excel";
                                 ...
                                 "vnd.multiad.creator.cif"; "vnd.music-niff";
                                 "vnd.musician"; "vnd.muvee.style"; "vnd.mynfc";
                                 "vnd.ncd.control"; "vnd.ncd.reference";
                                 "vnd.nervana"; "vnd.netfpx";
                                 "vnd.neurolanguage.nlu";
                                 "vnd.nintendo.nitro.rom";
                                 "vnd.nintendo.snes.rom"; "vnd.nitf";
                                 "vnd.noblenet-directory";
                                 "vnd.noblenet-sealer"; "vnd.noblenet-web";
                                 "vnd.nokia.catalogs"; "vnd.nokia.conml+wbxml";
                                 "vnd.nokia.conml+xml";
                                 ...
                                 "vnd.oma.lwm2m+json"; "vnd.oma.pal+xml";
                                 ...
                                 "vnd.onepager"; "vnd.openblox.game+xml";
                                 "vnd.openblox.game-binary"; "vnd.openeye.oeb";
                                 ...
                                 "vnd.orange.indata"; "vnd.osa.netdeploy";
                                 ...
                                 "vnd.powerbuilder7-s"; "vnd.powerbuilder75";
                                 "vnd.powerbuilder75-s"; "vnd.preminet";
                                 ...
                                 "vnd.radisys.moml+xml"; "vnd.radisys.msml+xml";
                                 ...
                                 "vnd.rainstor.data"; "vnd.rapid";
                                 "vnd.realvnc.bed"; "vnd.recordare.musicxml";
                                 "vnd.recordare.musicxml+xml";
                                 "vnd.rig.cryptonote"; "vnd.route66.link66+xml";
                                 "vnd.rs-274x"; "vnd.ruckus.download";
                                 "vnd.s3sms"; "vnd.sailingtracker.track";
                                 "vnd.sbm.cid"; "vnd.sbm.mid2"; "vnd.scribus";
                                 "vnd.sealed.3df"; "vnd.sealed.csf";
                                 "vnd.sealed.doc"; "vnd.sealed.eml";
                                 "vnd.sealed.mht"; "vnd.sealed.net";
                                 "vnd.sealed.ppt"; "vnd.sealed.tiff";
                                 "vnd.sealed.xls";
                                 ...
                                 "vnd.shana.informed.package"; "vnd.siren+json";
                                 "vnd.smaf"; "vnd.smart.notebook";
                                 "vnd.smart.teacher";
                                 "vnd.software602.filler.form+xml";
                                 "vnd.software602.filler.form-xml-zip";
                                 "vnd.solent.sdkm+xml"; "vnd.spotfire.dxp";
                                 "vnd.spotfire.sfs"; "vnd.sss-cod";
                                 "vnd.sss-dtf"; "vnd.sss-ntf";
                                 "vnd.stepmania.package";
                                 "vnd.stepmania.stepchart"; "vnd.street-stream";
                                 "vnd.sun.wadl+xml"; "vnd.sus-calendar";
                                 "vnd.svd"; "vnd.swiftview-ics";
                                 "vnd.syncml+xml"; "vnd.syncml.dm+wbxml";
                                 "vnd.syncml.dm+xml";
                                 ...
                                 "vnd.tcpdump.pcap";
                                 "vnd.tmd.mediaflex.api+xml"; "vnd.tml";
                                 "vnd.tmobile-livetv"; "vnd.trid.tpt";
                                 "vnd.triscape.mxs"; "vnd.trueapp";
                                 "vnd.truedoc"; "vnd.ubisoft.webplayer";
                                 "vnd.ufdl"; "vnd.uiq.theme"; "vnd.umajin";
                                 "vnd.unity"; "vnd.uoml+xml";
                                 ...
                                 "vnd.uplanet.list"; "vnd.uplanet.list-wbxml";
                                 "vnd.uplanet.listcmd";
                                 "vnd.uplanet.listcmd-wbxml";
                                 "vnd.uplanet.signal"; "vnd.uri-map";
                                 "vnd.valve.source.material"; "vnd.vcx";
                                 "vnd.vd-study"; "vnd.vectorworks";
                                 ...
                                 "vnd.wt.stf"; "vnd.wv.csp+wbxml";
                                 "vnd.wv.csp+xml"; "vnd.wv.ssp+xml";
                                 ...
                                 "vnd.zzazz.deck+xml"; "voicexml+xml";
                                 "vq-rtcpxr"; "watcherinfo+xml";
                                 "whoispp-query"; "whoispp-response"; "widget";
                                 "wita"; "wordperfect5.1"; "wsdl+xml";
                                 "wspolicy+xml"; "x-www-form-urlencoded";
                                 "x400-bp"; "xacml+xml"; "xcap-att+xml";
                                 "xcap-caps+xml"; "xcap-diff+xml";
                                 "xcap-el+xml"; "xcap-error+xml"; "xcap-ns+xml";
                                 "xcon-conference-info+xml";
                                 "xcon-conference-info-diff+xml"; "xenc+xml";
                                 "xhtml+xml"; "xml"; "xml-dtd";
                                 "xml-external-parsed-entity"; "xml-patch+xml";
                                 "xmpp+xml"; "xop+xml"; "xslt+xml"; "xv+xml";
                                 "yang"; "yin+xml"; "zip"; "zlib";
                               ])
                            Map.empty))))))))
