  ...
  Map.add "video"
    ...
    (Map.add "text"
       (Set.of_list
          ...
          ; "richtext"; "rtf"; "rtp-enc-aescm128"; "rtploopback"; "rtx"; "sgml"
          ; "t140"; "tab-separated-values"; "troff"; "turtle"; "ulpfec"
          ; "uri-list"; "vcard"; "vnd.DMClientScript"; "vnd.IPTC.NITF"
          ; "vnd.IPTC.NewsML"; "vnd.a"; "vnd.abc"; "vnd.curl"
          ; "vnd.debian.copyright"; "vnd.dvb.subtitle"
       ...
       (Map.add "multipart"
          (Set.of_list
             [ "alternative"; "appledouble"; "byteranges"; "digest"; "encrypted"
             ; "example"; "form-data"; "header-set"; "mixed"; "parallel"
             ; "related"; "report"; "signed"; "voice-message"
             ; "x-mixed-replace" ])
          (Map.add "model"
             (Set.of_list
                      ...
                      (Map.add "audio"
                         ...
                         (Map.add "application"
                            (Set.of_list
                               ...
                               ; "vnd.balsamiq.bmml+xml"; "vnd.balsamiq.bmpr"
