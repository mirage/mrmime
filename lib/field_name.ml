...
let resent_date = "Resent-Date"
let resent_from = "Resent-From"
let resent_sender = "Resent-Sender"
let resent_to = "Resent-To"
let resent_cc = "Resent-Cc"
let resent_bcc = "Resent-Bcc"
let resent_message_id = "Resent-Message-ID"
let resent_reply_to = "Resent-Reply-To"
